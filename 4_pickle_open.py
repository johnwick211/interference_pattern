...
voltages, k_values, phase_values, intensity_values, intensity_values_fit, displacement = data[:]
#linear_optimised_params: GRADIENT = [0], Y-INTERCEPT = [1]
